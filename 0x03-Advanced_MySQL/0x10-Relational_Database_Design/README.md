...
--
-- Creating the `takes_course` table
--
...
-- Populating the participant table
...
-- Populating the takes_course table
...
-- Find all courses in English whose course length is greater than the average course length
SELECT *
FROM `course`
WHERE `language` = "ENG" AND `course_length_weeks` > ALL
