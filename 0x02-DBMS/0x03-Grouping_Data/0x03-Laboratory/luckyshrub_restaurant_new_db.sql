...
CREATE TABLE `employees_orders` (
  ...
  `employee_id` INT NOT NULL,
  `status` VARCHAR(150),
  `handling_cost` INT DEFAULT NULL,
  CONSTRAINT `pk_employees_orders` PRIMARY KEY (`employee_id`, `order_id`),
  CONSTRAINT `fk_employees_orders_employees` FOREIGN KEY (`employee_id`) REFERENCES `employees`(`employee_id`),
  CONSTRAINT `fk_employees_orders_orders` FOREIGN KEY (`order_id`) REFERENCES `orders`(`order_id`)
);
